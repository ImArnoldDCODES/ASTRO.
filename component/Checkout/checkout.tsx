        ...
        <View style={tw`mx-6 mb-8`}>
          ...
          <View style={tw`mt-4`}>
            ...
            <ModalDropdown
              ...
              style={tw`mt-4 p-2 border border-[#747474]`}
            >
              <MaterialIcons
          ...
          <View style={tw`mt-16 items-center justify-center`}>
                <TouchableOpacity style={tw`bg-[#3341C1] py-4 px-8 rounded `} onPress={() => navigation.navigate("Checkout")}>
                    <Text style={tw`text-[#fff] font-satoshi`}>Proceed to payment</Text>
                </TouchableOpacity>

                <Text style={tw`mt-5 font-satoshi text-[#3348C9] underline text-[16px]`}>Go back to cart</Text>
            </View>
        </View>
        </ScrollView>
        <Navbar />
